...
public class DCReportConverters : IValueConverter
{
	public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
		=> parameter switch
		{
			...
			"NPTCoastalRegionArea" => value is byte areaCode ? GetNPTCoastalRegionAreaText(areaCode) : "不明",
			"NPTCoastalRegion" => value is byte regionCode ? GetNPTCoastalRegionText(regionCode) : "不明",
	...
	/// <summary>
	/// 北西太平洋津波の予報地点が属する沿岸地域名を取得する
	/// </summary>
	public static string GetNPTCoastalRegionAreaText(byte code) => code switch
	{
		1 or 2 or 66 or 67 => "カムチャツカ半島東海岸",
		3 or 4 => "千島列島",
		5 or 6 or 7 or (>= 68 and <= 70) => "韓国南海岸",
		8 or (>= 71 and <= 74) => "台湾",
		>= 9 and <= 14 => "フィリピン東海岸",
		(>= 15 and <= 20) or 75 => "イリアンジャヤ北海岸",
		(>= 21 and <= 28) or 76 => "パプアニューギニア北海岸",
		29 or 30 => "マリアナ諸島",
		31 => "パラオ",
		>= 32 and <= 35 => "ミクロネシア",
		36 => "マーシャル諸島",
		37 or 38 or 39 or 77 => "ソロモン諸島北海岸",
		40 or 41 or (>= 78 and <= 82) => "ソロモン海",
		83 => "珊瑚海",
		>= 84 and <= 86 => "東シナ海沿岸",
		_ => code.ToString(),
	};
	...
	/// 北西太平洋津波の予報地点名を取得する
	/// </summary>
	public static string GetNPTCoastalRegionText(byte code) => code switch
	{
		1 => "ウスト・カムチャツク",
		2 => "ペトロパブロフスク・カムチャツキー",
		3 => "セベロ・クリリスク",
		...
		40 => "ムンダ",
		41 => "ホニアラ",
		73 or (>= 42 and <= 65) or (>= 87 and <= 96) => $"予約済み({code})",
		66 => "カラギンスキー島",
		67 => "ニコリスコエ",
		68 => "統営",
		69 => "黒山島",
