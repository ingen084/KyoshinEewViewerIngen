...
public struct Intensity
{
	...
	/// </summary>
	public IntensityForecast? Forecast => _forecast ??= (Node.TryFindChild(Literals.Forecast(), out var n) ? new IntensityForecast(n) : null);
	...
	/// </summary>
	public IntensityObservation? Observation => _obserbation ??= (Node.TryFindChild(Literals.Observation(), out var n) ? new IntensityObservation(n) : null);
}
