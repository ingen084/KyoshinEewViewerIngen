...
public struct IntensityStation
{
	...
	/// </summary>
	public string Int => @int ??= (Node.TryFindStringNode(Literals.Int(), out var n) ? n : throw new JmaXmlParseException("Int ノードが存在しません"));
	...
	private Sva? sva = null;
	/// <summary>
	/// 絶対速度応答スペクトルの 1.6 秒から 7.8 秒までの周期帯における最大値
	/// </summary>
	public Sva? Sva => sva ??= (Node.TryFindChild(Literals.Sva(), out var n) ? new(n) : null);
