...
public struct HeadData
{
	...
	private DateTimeOffset? targetDateTime = null;
	/// <summary>
	...
	private string? targetDuration = null;
	/// <summary>
	...
	private string? targetDTDubious = null;
	/// <summary>
	...
	private DateTimeOffset? validDateTime = null;
	/// <summary>
	/// 電文の内容について無効となる時刻<br/>
	/// 存在しない場合は <c>null</c>
	...
	private string? infoKindVersion = null;
	/// <summary>
